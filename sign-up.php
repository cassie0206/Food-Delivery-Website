	...
	<script>
		function check_account(Account){
			if(Account != ""){
				...
				documnet.getElementById("msg").innerHTML = "";
			}
		}
	</script>
	</head>
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="register.php" method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Account" id="Account" oninput="check_account(this.value);" placeholder="Account" autocomplete="off">
							<lable id="msg" style="color:red; font-size:50%;"></lable>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<!-- <input type="button" onclick="" value="Sign Up" class="btn btn-primary">  -->
						</div> 
